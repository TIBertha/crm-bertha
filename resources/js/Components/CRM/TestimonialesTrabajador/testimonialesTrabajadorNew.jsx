...
class TestimonialesTrabajadorNew extends Component {
    constructor(props) {
        super(props);
    ...
    save(e) {
        ...
        ajaxTestimonialesTrabajadorNew(this.state).then(r => {
    ...
    render() {
        ...
        return(
            <>
                <TitleLabel content={'Agregar nuevo testimonial[trabajador]'} />
...
export default withRouter(TestimonialesTrabajadorNew);
